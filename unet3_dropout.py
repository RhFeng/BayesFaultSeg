...
# define the dropout ratio to simulate a Bayesian network training
dropout_prob = 0.1
...
def unet(pretrained_weights = None,input_size = (128,128,128,1)):
    ...
    conv1 = Dropout(dropout_prob)(conv1,training=True)
    pool1 = MaxPooling3D(pool_size=(2,2,2))(conv1)

    conv2 = Conv3D(32, (3,3,3), activation='relu', padding='same')(pool1)
    conv2 = Conv3D(32, (3,3,3), activation='relu', padding='same')(conv2)
    conv2 = Dropout(dropout_prob)(conv2,training=True)
    pool2 = MaxPooling3D(pool_size=(2,2,2))(conv2)

    conv3 = Conv3D(64, (3,3,3), activation='relu', padding='same')(pool2)
    conv3 = Conv3D(64, (3,3,3), activation='relu', padding='same')(conv3)
    conv3 = Dropout(dropout_prob)(conv3,training=True)
    ...
    conv4 = Dropout(dropout_prob)(conv4,training=True)
    ...
    conv5 = Dropout(dropout_prob)(conv5,training=True)
    ...
    conv6 = Dropout(dropout_prob)(conv6,training=True)
    ...
    conv7 = Dropout(dropout_prob)(conv7,training=True)
